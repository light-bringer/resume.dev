import { OpenSource as OpenSourceType } from '@/types/resume'

interface OpenSourceProps {
  projects: OpenSourceType[]
}
            ...
            <div className="flex items-start justify-between gap-4 mb-2">
              ...
              {project.url && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-shrink-0 text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
